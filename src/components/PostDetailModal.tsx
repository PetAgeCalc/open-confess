...
export const PostDetailModal: React.FC<PostDetailModalProps> = ({ confession, onClose }) => {
  ...
  return (
    <div className="fixed inset-0 z-50 overflow-y-auto bg-black/60 backdrop-blur-sm flex items-center justify-center p-4">
      ...
      <div className="relative w-full max-w-lg mx-auto bg-white rounded-3xl shadow-2xl overflow-hidden flex flex-col max-h-[88vh] z-10 my-auto">
        ...
        <div className="flex-1 overflow-y-auto">
          {/* Post Image */}
          {confession.imageUrl && (
            <div className="w-full max-h-72 sm:max-h-80 overflow-hidden bg-stone-100">
              <img 
